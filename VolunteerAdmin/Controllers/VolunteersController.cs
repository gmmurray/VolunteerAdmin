...
namespace VolunteerAdmin.Controllers
{
    public class VolunteersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,Username,Password,HomePhone,CellPhone,WorkPhone,Address,Email,Education,EmergencyName,EmergencyHomePhone,EmergencyWorkPhone,EmergencyEmail,EmergencyAddress,DLCopyOnFile,SSCopyOnFile,Approved")] Volunteer volunteer)
        {
